...
<body>
    <nav class="navbar navbar-light navbar-expand-md sticky-top navigation-clean" style="background-color: rgb(9,40,71);">
        <div class="container"><a class="navbar-brand" href="<?= base_url('c_user'); ?>" style="color: rgb(255,255,255);">QA Document Check</a>
            ...
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    echo $arr[0]; ?>
                        ...
                        <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="<?= base_url('c_user'); ?>">Beranda</a>
    ...
    <div data-aos="fade-up" data-aos-once="true" class="contact-clean">
        <?php if (empty($res)) { ?>
            <center>
                <form style="max-width: 700px;">    
                    ...
                    <div class="form-group text-center"><a class="btn btn-primary" role="button" href="<?= base_url('c_user/viewproject') ?>" style="margin-right: 5px;">Manage Project</a></div>
                </form>
            </center>
        <?php } else {?>
        <form method="post" style="max-width: 700px;">
            ...
            <p>PIC AM*</p>
            <div class="form-group"><input class="form-control" type="text" name="nama" placeholder="Your answer" disabled="" value="<?= $res['nama'] ?>"></div>
            <p>Unit AM*</p>
            ...
            <div class="form-group text-center"><a class="btn btn-primary" role="button" href="<?= base_url('c_user/viewproject') ?>" style="margin-right: 5px;">Back</a><a style="margin-left: 5px;" class="btn btn-success" role="button" href="<?= base_url('c_user/pdf/') . $res['idproject'] .'/'. $res['namaproject']?>" ><i class="fas fa-file"></i>&nbsp;Download</a></div>
        </form>
        <?php } ?>
    </div>
