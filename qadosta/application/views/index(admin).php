            ...
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    echo $arr[0]; ?>
                        ...
                        <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="<?= base_url('c_admin') ?>">Beranda</a>
            ...
            <div class="row justify-content-center features">
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fas fa-tasks icon"></i>
                        <h3 class="name">Manage Project</h3>
                        <p class="description">Halaman untuk menampilkan project yang terdaftar, menambahkan, view detail, dan mengedit project.<br></p>
                        <a class="btn btn-primary" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_admin/viewproject') ?>">Menuju Halaman</a></div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fas fa-user-alt icon"></i>
                        <h3 class="name">Manage User</h3>
                        <p class="description">Halaman untuk menampilkan user yang terdaftar, menambahkan, menonaktifkan, dan mengaktifkan user.<br></p>
                        <a class="btn btn-primary" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_admin/manageuser') ?>">Menuju Halaman</a></div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="far fa-edit icon"></i>
                        <h3 class="name">Change Password</h3>
                        <p class="description">Halaman untuk merubah password akun yang sebelumnya menjadi password yang lebih baru.</p>
                        <a class="btn btn-primary" role="button" style="color: rgb(255,255,255);" href="<?= base_url('c_admin/changepassword') ?>">Menuju Halaman</a></div>
                </div>
            </div>
        </div>
    </div>
