...
<body>
    ...
    <div data-aos="fade-up" data-aos-once="true" class="contact-clean">
        <form method="post" style="max-width: 700px;" id="formInputProject">
            ...
            <p>PIC AM*</p>
            <div class="form-group"><input class="form-control" type="text" name="picam" placeholder="Your answer" name="keyword" id="namapicam"><?= form_error('picam', '<small class="text-danger pl-3">', '</small>'); ?></div>
            <p>Unit AM*</p>
