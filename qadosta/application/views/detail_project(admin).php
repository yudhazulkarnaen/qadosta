...
<body>
    ...
    <div data-aos="fade-up" data-aos-once="true" class="contact-clean">
        ...
        <form method="post" style="max-width: 700px;">
            ...
            <div class="form-group text-center"><a class="btn btn-primary" role="button" href="<?= base_url('c_admin/viewproject') ?>" style="margin-right: 5px;">Back</a><a style="margin-left: 5px;" class="btn btn-success" role="button" href="<?= base_url('c_admin/pdf/') . $res['idproject'] .'/'. $res['namaproject']?>" ><i class="fas fa-file"></i>&nbsp;Download</a></div>
        </form>
        <?php } ?>
    </div>
