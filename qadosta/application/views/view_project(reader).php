            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    <div class="text-center intro" style="max-width: 730px;">
                        <h2>View Project</h2>
                        <p class="text-left">Halaman untuk menampilkan project yang terdaftar, view detail project.</p>
                    </div>
                </div>
                <div class="col-sm-4">
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-12">
                    ...
                    <form action="<?= base_url('c_reader/viewproject'); ?>" method="post">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <?php } ?>
                                    ...
                                    <?php
                                    echo ('
                                        <td><a class="btn btn-success" role="button" href="' . base_url('c_reader/detailproject/') .$p['idproject'] . '"><i class="fa fa-search"></i>&nbsp;View Detail</a></td>
                                    ');
                                    ?>
                                </tr>
                                    <?php endforeach; ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#nameproject').autocomplete({
                source: "<?php echo site_url('c_reader/autocompleteproject'); ?>",

                select: function(event, ui) {
                    $('[name="nameproject"]').val(ui.item.label);
