            ...
            <div class="row justify-content-center features">
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fas fa-tasks icon"></i>
                        ...
                        <p class="description">Halaman untuk menampilkan project yang terdaftar, menambahkan, view detail project.<br></p>
                        <a class="btn btn-primary" role="button" href="<?= base_url('c_user/viewproject') ?>">Menuju Halaman</a></div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="far fa-edit icon"></i>
                        ...
                        <a class="btn btn-primary" role="button" href="<?= base_url('c_user/changepassword') ?>">Menuju Halaman</a></div>
                </div>
            </div>
        </div>
    </div>
