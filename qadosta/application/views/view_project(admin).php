...
<body>
            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    <div class="text-center intro" style="max-width: 730px;">
                        ...
                        <a class="btn btn-primary" role="button" href="<?= base_url('c_admin/addproject') ?>">Tambah Project</a></div>
                </div>
                <div class="col-sm-4">
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-12">
                    ...
                    <form action="<?= base_url('c_admin/viewproject'); ?>" method="post">
                    	<div class="input-group mb-3">
                    		<input type="text" class="form-control" placeholder="Cari project..." name="keyword" id="namaproject" autocomplete="off" autofocus>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="table-primary">Edit Project</th>
                            ...
                            <tr>
                                ...
                                <?php
                                    echo ('
                                    <td><a class="btn btn-info" role="button" href="' . base_url('c_admin/editproject/') .$p['idproject'] . '"><i class="fas fa-edit"></i>&nbsp;Edit Project</a></td>
                                    ');
                                    ?>

                                    <?php
                                    echo ('
                                        <td><a class="btn btn-success" role="button" href="' . base_url('c_admin/detailproject/') .$p['idproject'] . '"><i class="fa fa-search"></i>&nbsp;View Detail</a></td>
                                    ');
                                    ?>
                                </tr>
                                    <?php endforeach; ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#namaproject').autocomplete({
                source: "<?php echo site_url('c_admin/autocompleteproject'); ?>",
